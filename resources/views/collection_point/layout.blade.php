  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('collectionpoint.collectionpoint')}}"><img src="{{ asset('logo/logo.png')}}" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('collectionpoint.collectionpoint')}}"><img src="{{ asset('logo/mini_logo.png')}}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
              <a class="dropdown-item font-weight-medium" href="{{ route('collectionpoint.profileupdate')}}">
                Edit profile
              </a>
              {{-- <div class="dropdown-divider"></div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('collectionpoint.collectionpoint')}}">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#bikeBooking" aria-expanded="false" aria-controls="bikeBooking">
                <i class="fa fa-user-o menu-icon"></i>
                <span class="menu-title">Procurement Requests</span>
                {{-- <span class="badge badge-warning">3</span> --}}
              </a>
              <div class="collapse" id="bikeBooking">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('collectionpoint.bike-buy.index') }}">Request List</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('collectionpoint.bike_buyed') }}">Bikes Bought List</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('collectionpoint.bike_buyed_assign') }}">Bike assign to workshop</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('collectionpoint.assigned_bike_status') }}">Assigned Bike Status</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('collectionpoint.bike_cancelled') }}">Cancelled List</a></li>
