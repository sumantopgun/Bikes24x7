...
@section('title', 'Bike assign to workshop')
@push('style')
...
<div class="content-wrapper">
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="modal fade" id="workshopAssignId" tabindex="-1" role="dialog" aria-labelledby="workshopAssignId-2" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <form method="POST" class="forms-sample" action="{{ route('collectionpoint.bike_assign_workshop') }}">
                        @csrf
        ...
        @else
            <p class="alert alert-info">No assign to workshop list found.....</p>
        @endif
        </div>
    </div>
</div>
