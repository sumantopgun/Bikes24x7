                    ...
                    <tbody>
                        @foreach ($works_done as $work)
                            <tr>                       
                                ...
                                <td>
                                    <a href="{{ route('workshop_main.assign_to_shop', $work->id ) }}" type="button" class="btn btn-primary btn-sm" >Assign to Showroom</a> 
                                    <a href="{{ route('workshop_main.working_details', $work->id ) }}" type="button" class="btn btn-info btn-sm">Working Details</a>
                                </td>                            
                            </tr>
                        @endforeach   
                    </tbody>
