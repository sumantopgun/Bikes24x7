...
@section('content')
    <div class="content-wrapper">
        <form method="POST" action="{{ route('workshop_main.sale.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control" id="bike_name" name="bike_name" placeholder="Bike Name" value="{{ old('bike_name') }}" required>
                            </div>
                            @error('bike_name')
                            ...
                            <div class="form-group row">
                                <label for="bike_reg_date">Registration Date</label>
                                    <input type="date" class="form-control" id="bike_reg_date" name="bike_reg_date" value="{{ old('bike_reg_date') }}" required>
                            </div>
                            @error('bike_reg_date')
                                <label class="error text-danger">{{ $message }}</label>
                            @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <input type="number" class="form-control" id="number_of_owners" name="number_of_owners" placeholder="Number of owners" value="{{ old('number_of_owners') }}" required>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <input type="number" class="form-control" id="total_kilometers" name="total_kilometers" placeholder="Total Kilometers" value="{{ old('total_kilometers') }}" required>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control" id="bike_color" name="bike_color" placeholder="Bike Color" value="{{ old('bike_color') }}" required>
                            </div>
                            @error('bike_color')
                                <label class="error text-danger">{{ $message }}</label>
                            @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="number" class="form-control" id="bike_new_price" name="bike_new_price" placeholder="Bike Cost Price" value="{{ old('bike_new_price') }}" required>
...
@push('scripts')
    ...
    //    });
       ...
       $('#datepicker-popup').datepicker({
        ...
        // $( "#bike_reg_date" ).datepicker({  maxDate: 0 });
    </script>
    <script>
        // $(function(){
