        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form method="POST" class="forms-sample" action="{{ route('workshop_main.offers.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" oninput="validity.valid||(value='');" class="form-control" id="offer_amount" name="offer_amount" value="{{ old('offer_amount') }}" placeholder="Amount" required>
                        </div>
                        @error('offer_amount')
                            <label class="error text-danger">{{ $message }}</label>
                        @enderror
