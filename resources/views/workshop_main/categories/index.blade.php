...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('workshop_main.categories.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Brand</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a button class="btn btn-success" href="{{route('workshop_main.categories.edit', $category->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
