...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('admin.owner-deduction-rate.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Deduction Rate</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a button class="btn btn-success" href="{{route('admin.owner-deduction-rate.edit', $DeductionRate->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
