              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                  <form method="POST" action="{{route('admin.profile.update', $user->id)}}">
                    ...
                    <div class="form-group">
                        <label for="usesLastName">First Name</label>
                ...
                <div class="tab-pane fade" id="avatar" role="tabpanel" aria-labelledby="avatar-tab">
                  ...
                  <form method="POST" action="{{route('admin.updatepic',$user->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                ...
                <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                  <form id="form-change-password" role="form" method="POST" action="{{route('admin.changepassword')}}">
                    @csrf
                    @method("PUT")
                    <div class="form-group">
