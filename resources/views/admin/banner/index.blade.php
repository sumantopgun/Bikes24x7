...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('admin.banner.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Banner</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a button class="btn btn-success" href="{{route('admin.banner.edit', $banner->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
