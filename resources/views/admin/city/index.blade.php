...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('admin.city.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New City</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    {{-- <a button class="btn btn-outline-primary" href="{{route('admin.city.show', $city->id)}}">View</a> --}}
                                    <a button class="btn btn-success" href="{{route('admin.city.edit', $city->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
