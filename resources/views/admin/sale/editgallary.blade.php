...
<div class="content-wrapper">
    <div class="row grid-margin">
        ...
        <div class="card">
                ...
                <div id="lightgallery" class="row lightGallery">
                    ...
                    @foreach ($gallaryimg as $image)
                        <span>
                            ...
                            <center>
                                <a href="{!! route('admin.deleteimage', [$sell->id,$image]) !!}" class='btn btn-default btn-xs btn-outline-primary' onclick="return confirm('Are you sure?')">Delete</a>
                            </center>
            ...
            @endif
            <center><br>
                <a href="{{ route('admin.sale.index') }}" type="button" class="btn btn-success mr-2">Back</a>
            </center>
            </div>
        </div>
        </div>
