...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('admin.sale.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Product</a><br><br>
        @if (session('message'))
                ...
                <tbody>
                    @foreach ($sales as $sale)
                        <tr>                       
                            ...
                            <td>
                                <a button class="btn btn-primary" href="{{route('admin.gallaryedit', $sale->id)}}">Edit Gallery</a>
                            </td>
                            <td>{{ $sale->bike_sell_status }}</td>
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    {{-- <a button class="btn btn-outline-primary" href="#">View</a> --}}
                                    <a button class="btn btn-success" href="{{route('admin.sale.edit', $sale->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
