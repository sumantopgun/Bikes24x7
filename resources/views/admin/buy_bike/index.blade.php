...
<div class="content-wrapper">
    <div class="card">
        ...
        <form class="form-inline" method="POST" action="{{route('admin.importcsv')}}" enctype="multipart/form-data">
            @csrf
        ...
        <a href="{{route('admin.buy-bikes.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Fees</a><br><br>
        @if (session('message'))
                        ...
                        <tr id="{{$bike->id}}">                 
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a button class="btn btn-success" href="{{route('admin.buy-bikes.edit', $bike->id)}}">Edit</a>
                                    {{-- <a button class="btn btn-danger" href="{{route('admin.buy-bikes.edit', $bike->id)}}">Delete</a> --}}
