                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a button class="btn btn-outline-primary" href="{{route('admin.customer.show', $customer->id)}}">View</a>
                                    <a button class="btn btn-success" href="{{route('admin.customer.edit', $customer->id)}}">Edit</a>
                                </div> 
                            </td>                                    
                        </tr>
                    @endforeach   
