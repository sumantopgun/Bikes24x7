  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('admin.admin')}}"><img src="{{ asset('logo/logo.png')}}" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('admin.admin')}}"><img src="{{ asset('logo/mini_logo.png')}}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
              <a class="dropdown-item font-weight-medium" href="{{ route('admin.profileupdate')}}">
                Edit profile
              </a>
              {{-- <div class="dropdown-divider"></div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="user-layouts">
                  <ul class="nav flex-column sub-menu">                    
                    <li class="nav-item"> <a class="nav-link" href="{{route('admin.customer.index')}}">Customers</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.categories.index') }}">Bike Brand</a></li>                
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.models.index') }}">Make</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.sale.index') }}">Bike Entry for Selling</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.offers.index') }}">Offers</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.shop.index') }}">Create Showroom</a></li>                  
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="buy-bikes">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.buy-bikes.index') }}">BVC Bike Data</a></li>  
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.collection-point.index') }}">Collection Points</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.owner-deduction-rate.index') }}">Owner Deduction Rate</a></li>  
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.km-deduction-rate.index') }}">KM Deduction Rate</a></li> 
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.insurance-deduction-rate.index') }}">Insurance Deduction Rate</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="workshop">
                <ul class="nav flex-column sub-menu">                  
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.workshop.index') }}">Workshop List</a></li>            
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="rto">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.rto-office.index')}}">RTO Office</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.rto-fees.index')}}">RTO Fees</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.rto-insurance-fees.index')}}">Insurance Fees</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('admin.rto-document.index')}}">RTO Document</a></li>
                </ul>
              </div>
            </li>
