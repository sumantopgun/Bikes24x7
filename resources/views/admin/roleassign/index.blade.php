...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
        <h4 class="card-title" style="text-align: center;">Employees</h4>
        @if (session('message'))
        ...
        <div class="row">
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a button class="btn btn-success" href="#">Details</a>
                                </div> 
                            </td> 
                        </tr>
                    @endforeach   
            ...
            <div class="modal fade" id="assignRoleId" tabindex="-1" role="dialog" aria-labelledby="assignRoleId-2" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <form method="POST" class="forms-sample" action="{{ route('admin.assignrole') }}">
                        @csrf
