  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('frontpage')}}"><img src="{{ asset('logo/logo.png')}}" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('frontpage')}}"><img src="{{ asset('logo/mini_logo.png')}}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
              <a class="dropdown-item font-weight-medium" href="{{ route('customer.profileupdate')}}">
                Edit profile
              </a>
              {{-- <div class="dropdown-divider"></div>
          ...
          <ul class="nav">
            <li class="nav-item nav-profile">
              <div class="nav-link">
                ...
                <div class="profile-name">
                  <p class="name">
                    @if (Auth::user()->user_first_name==null)
                      <a href="{{ route('customer.profileupdate')}}" role="button" class="btn btn-info btn-fw">Update Profile</a>
                    @else
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="user-layouts">
                  <ul class="nav flex-column sub-menu">                    
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customer.orders.index') }}">Active List</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customer.myorder') }}">My Orders</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customer.cancelledlist') }}">Cancelled Orders</a></li>
                  </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="rtoapplication">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.rto_application', $type='rto-transfer-application') }}">RTO transfer</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.rto_application', $type='loan-cancellation-application') }}">Loan cancellation</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.rto_application', $type='noc-application') }}">NOC</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.rto_application', $type='repassing-application') }}">Repassing</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.rto_application', $type='duplicate-registration-certificate-application') }}">Duplicate Registration Certificate</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.rto_application', $type='license-application') }}">License</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.rto_application', $type='passing-application') }}">Passing</a></li>
                </ul>
              </div>
            </li>

            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#sellingbike" aria-expanded="false" aria-controls="sellingbike">
                <i class="fa fa-user-o menu-icon"></i>
                <span class="menu-title">Bike Selling List</span>
                {{-- <span class="badge badge-warning">3</span> --}}
              </a>
              <div class="collapse" id="sellingbike">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.bike-selling.index') }}">Active List</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.bike_sold') }}">Sold List</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('customer.bike_cancelled') }}">Cancelled List</a></li>
                </ul>
              </div>
            </li>
