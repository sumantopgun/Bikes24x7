        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form method="POST" class="forms-sample" action="{{ route('superadmin.buy-bikes.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="model_cc" name="model_cc" maxlength="100" placeholder="Model CC" value="{{ old('model_cc') }}" required>
                        </div>
                        @error('model_cc')
                            <label class="error text-danger">{{ $message }}</label>
                        @enderror
