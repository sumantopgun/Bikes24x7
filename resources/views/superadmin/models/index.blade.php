...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('superadmin.models.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Model</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a button class="btn btn-success" href="{{route('superadmin.models.edit', $model->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
