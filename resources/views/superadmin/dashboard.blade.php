      ...
      <div class="row flex-grow">
        ...
        <div class="col-12 col-md-4 col-lg-12 grid-margin stretch-card">
          <div class="card bg-success">
            <div class="text-white py-3 px-4">
              <h6 class="card-title text-white mb-0">Sales Graph</h6>
              <p>Rs. 56569</p>
              <div class="chart-container">
        ...
        <div class="card-body">
          ...
          <div class="list d-flex align-items-center border-bottom py-3">
            ...
            <div class="wrapper w-100 ml-3">
              <p class="mb-0"><b>Subhankar </b>posted in Yamaha</p>
          ...
          <div class="list d-flex align-items-center border-bottom py-3">
            <img class="img-sm rounded-circle" src="http://via.placeholder.com/100x100/f4f4f4/000000" alt="">
            <div class="wrapper w-100 ml-3">
              <p class="mb-0"><b>Arpita </b>posted in Suzuki</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                  <i class="mdi mdi-clock text-muted mr-1"></i>
                  <p class="mb-0">Awesome!</p>
          ...
          <div class="list d-flex align-items-center border-bottom py-3">
            <img class="img-sm rounded-circle" src="http://via.placeholder.com/100x100/f4f4f4/000000" alt="">
            <div class="wrapper w-100 ml-3">
              <p class="mb-0"><b>Javed </b>posted in Yamaha</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                  <i class="mdi mdi-clock text-muted mr-1"></i>
          ...
          <div class="list d-flex align-items-center pt-3">
            <img class="img-sm rounded-circle" src="http://via.placeholder.com/100x100/f4f4f4/000000" alt="">
            <div class="wrapper w-100 ml-3">
              <p class="mb-0"><b>Riya </b>posted in KTM Bikes</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                  <i class="mdi mdi-clock text-muted mr-1"></i>
                  <p class="mb-0">Awesome!</p>
