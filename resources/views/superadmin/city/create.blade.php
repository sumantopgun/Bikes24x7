        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form method="POST" class="forms-sample" action="{{ route('superadmin.city.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="city_state" name="city_state" placeholder="State Name" value="{{ old('city_state') }}" required>
                        </div>
                        @error('city_state')
