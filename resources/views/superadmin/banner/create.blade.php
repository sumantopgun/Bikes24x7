        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form method="POST" class="forms-sample" action="{{ route('superadmin.banner.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="banner_text">Banner Text</label>
                            <textarea class="form-control" id="banner_texteditor" name="banner_text" rows="3">{{ old('banner_text') }}</textarea>
                        </div>
                        @error('banner_text')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="50" class="form-control" name="button_text" value="{{ old('button_text') }}">
                        </div>
                        @error('button_text')
                            <label class="error text-danger">{{ $message }}</label>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" maxlength="50" class="form-control" name="btn_link" value="{{ old('btn_link') }}">
                        </div>
                        @error('btn_link')
                            <label class="error text-danger">{{ $message }}</label>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="15" class="form-control color-picker" name="button_text_color" value="#312020">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="15" class="color-picker form-control" name="button_bg_color" value="#ffe74c">
                        </div>
