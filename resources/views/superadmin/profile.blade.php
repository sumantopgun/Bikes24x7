            ...
            <div class="wrapper">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                  <form method="POST" action="{{route('superadmin.profile.update', $user->id)}}">
                    @csrf
                    @method("PUT")
                    @if (session('message'))
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" disabled id="userCountry" name="user_country" value="{{ $user->user_country }}">
                    </div>
                    <div class="form-group">
                ...
                <div class="tab-pane fade" id="avatar" role="tabpanel" aria-labelledby="avatar-tab">
                  ...
                  <form method="POST" action="{{route('superadmin.updatepic',$user->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                ...
                <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                  <form id="form-change-password" role="form" method="POST" action="{{route('superadmin.changepassword')}}">
                    @csrf
                    @method("PUT")
                    <div class="form-group">
