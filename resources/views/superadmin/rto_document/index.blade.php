...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('superadmin.rto-document.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New RTO Document</a><br><br>
        @if (session('message'))
                        ...
                        <tr id="{{$rtoDoc->id}}">                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a button class="btn btn-success" href="{{route('superadmin.rto-document.edit', $rtoDoc->id)}}">Edit</a>
