        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form method="POST" class="forms-sample" action="{{ route('superadmin.shop.update', $shop->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="shop_name">Showroom Name</label>
                            <input type="text" class="form-control" id="shop_name" name="shop_name" placeholder="Shop Name" value="{{ $shop->shop_name }}" required>
                        </div>
                        @error('shop_name')
