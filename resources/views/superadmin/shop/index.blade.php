...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('superadmin.shop.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Showroom</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a button class="btn btn-success" href="{{route('superadmin.shop.edit', $shop->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
        ...
        @else
            <p class="alert alert-info">No Shop Found.....</p>
        @endif
        </div>
    </div>
</div>
