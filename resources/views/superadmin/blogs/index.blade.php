...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('superadmin.blogs.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Blog</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a button class="btn btn-success" href="{{route('superadmin.blogs.edit', $blog->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
