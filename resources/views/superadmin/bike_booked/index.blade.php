...
@section('title', 'Bike Booked List')
@push('style')
...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
        <h4 class="card-title" style="text-align: center;">Bike Booked List</h4><br><br>
                ...
                <tbody>
                    @foreach ($orders as $order)
                        <tr>                       
                            ...
                            <td>
                                {{ $order->appointments->appointments_date ?? 'N/A' }} & {{ $order->appointments->appointments_time ?? 'N/A' }}                     
                            </td>
        ...
        @else
            <p class="alert alert-info">Booking not found.....</p>
        @endif
        </div>
    </div>
</div>
