...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('superadmin.workshop.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Workshop</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a button class="btn btn-success" href="{{route('superadmin.workshop.edit', $shop->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
        ...
        @else
            <p class="alert alert-info">No Workshops Found.....</p>
        @endif
        </div>
    </div>
</div>
