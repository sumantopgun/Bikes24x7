        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                    <center>
                        <h4 class="card-title">Workshop Point</h4>
                    </center>
                    <form method="POST" class="forms-sample" action="{{ route('superadmin.workshop.store') }}">
                        @csrf
                        <div class="form-group">
                            <label for="shop_name">Workshop Name</label>
                            <input type="text" class="form-control" id="shop_name" name="shop_name" placeholder="Workshop Name" value="{{ old('shop_name') }}" required>
                        </div>
                        @error('shop_name')
