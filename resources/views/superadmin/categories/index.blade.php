...
<div class="content-wrapper">
    <div class="card">
        ...
        <form class="form-inline" method="POST" action="{{route('superadmin.importSalesCsv')}}" enctype="multipart/form-data">
            @csrf
        ...
        <a href="{{route('superadmin.categories.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Brand</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    {{-- <a button class="btn btn-outline-primary" href="{{route('superadmin.categories.show', $category->id)}}">View</a> --}}
                                    <a button class="btn btn-success" href="{{route('superadmin.categories.edit', $category->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
