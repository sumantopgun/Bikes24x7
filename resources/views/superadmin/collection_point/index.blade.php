...
<div class="content-wrapper">
    <div class="card">
        ...
        <a href="{{route('superadmin.collection-point.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Collection Point</a><br><br>
        @if (session('message'))
                        ...
                        <tr>                       
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a button class="btn btn-success" href="{{route('superadmin.collection-point.edit', $shop->id)}}">Edit</a>
                                </div> 
                            </td>                                   
                        </tr>
                    @endforeach   
