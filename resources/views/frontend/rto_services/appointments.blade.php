...
@section('title', 'RTO Appointments')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="#">RTO Appointments</a></li>
                        </ul>
                    </div>
                </div> --}}
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="book-list">
                            ...
                            <li> You will receive a call from our customer service, confirming your booking.</li> 
                            {{-- <li> A detailed live inspection of your bike will take place in front of you, and you will be given the best possible valuation for your bike.</li> --}}
                            <li> Please ensure to carry all related documents to the bike with you for the inspection for our bike inspector to verify.</li>
                            <ul class="book-list2">
                                ...
                                <li>Government approved identity documents (Aadhaar Card / Pan Card / Driver’s License) </li>
                                <li>Address Proof  (Aadhaar Card / Pan Card / Driver’s License) </li>
                                <li>2 Passport size photographs	</li>
                                <li>Bank NOC <span class="text-danger">(*If there's a loan on the vehicle) </span></li>
                            </ul>
                            {{-- <li> I After agreeing to the quoted price and verification of documents, we will buy your bike within 30 rains of the inspection.</li>  --}}
                            {{-- <li> Please keep in mind that the money will only be transferable to the account of the registered owner after receiving confirmation through their signature. </li> --}}
                        </ul>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="book-form">
                            <form method="POST" class="forms-sample" action="{{ route('rto-appointment-complete') }}">
                                @csrf
                                <input class="form-control" type="hidden" name="rto_application_id" value="{{ $request_id }}">

                                {{-- <input type="hidden" id="date-picked" name="date"></input> --}}
                                ...
                                <div class="fix-date-cal">
                                    ...
                                    <center><br class="br_mobile_off">
                                        <button type="submit" class="btn book-now-btn">Reserve Now</button>
                                    </center>
                                </div>
                            </form>
                        </div>
