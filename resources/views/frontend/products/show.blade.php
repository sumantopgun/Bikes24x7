...
@section('content')
    <div class="main2">
        ...
        {{-- @if ($product->bike_sell_status=='booked')
            <section class="product_des_section">
                <div class="container">
                    <div class="row">
                        <div class="product_des_main_div">
                            <div class="product_des_body">
                                <p>This bike has already been booked by the customer on 5th March and the 1000/- has been forfeited. It should be available to book again now - Please look into this.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                    <div class="panel-body bike_des_panel_body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-xs-6">
                                                                <div class="bike-cc">
                                                                <small>Brake System - Rear</small><p>{{ $product->bikeDetails->bike_rear_break_type ?? 'N/A' }}</p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4 col-xs-6">
                                                                <div class="bike-cc">
                                                                <small>Brake System - Front</small><p>{{ $product->bikeDetails->bike_front_break_type ?? 'N/A' }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div id="carousel-picks2" class="carousel-picks2 owl-carousel owl-theme" >
                                @foreach ($relateds as $related)
                                    <div class="item">
                                        @if ($related->bike_sell_status == 'sold')
                                            <span class="notify-badge">Sold</span>
                                        @elseif ($related->bike_sell_status == 'booked')
                                            <span class="notify-badge">Booked</span>
                                        @endif
                                        <div class="col-item {{ $related->bike_sell_status }}">
                                                @if ($related->offers)
                                            ...
                                            <div class="photo related">
                                                <a href="{{ route('product-details', $related->id) }}"><img src="{{ asset('storage/'.$related->bike_image) }}" class="img-responsive" alt="a" /></a>
                                            </div>
                                            <div class="info">
                                                {{-- <div class="row"> --}}
