...
var options = {
    ...
    "handler": function (response){
        ...
        document.getElementById('offer_id').value = "{{$need_data['offer_id']}}";
        document.getElementById('payments_sell_id').value = "{{$need_data['payments_sell_id']}}";
        document.getElementById('booking_requests_shop_id').value = "{{$need_data['booking_requests_shop_id']}}";
        document.getElementById('payments_amount').value = "{{$need_data['payments_amount']}}";
        document.getElementById('total_amount').value = "{{$need_data['total_amount']}}";
...
<form action="{{route('payment-complete')}}" method="POST" hidden>
        ...
        <input type="text" class="form-control" id="booking_requests_shop_id"  name="booking_requests_shop_id">
