                            ...
                            <tr>                       
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a button class="btn btn-outline-primary" href="{{route('rtoadmin.rto-application.show', $application->id)}}">Details</a>
                                    </div>
                                </td>  
                                <td>
                                    @if ($application->rto_applications_status == 'Complete')
                                        ...
                                        @else
                                            <a button class="btn btn-outline-primary" href="{{route('rtoadmin.rto-application.show', $application->id)}}/#invoiceInformation">Upload Invoice</a>
                                        @endif
                                    @else
