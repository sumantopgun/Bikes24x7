  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('rtoadmin.rtoadmin')}}"><img src="{{ asset('logo/logo.png')}}" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('rtoadmin.rtoadmin')}}"><img src="{{ asset('logo/mini_logo.png')}}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
              <a class="dropdown-item font-weight-medium" href="{{ route('rtoadmin.profileupdate')}}">
                Edit profile
              </a>
              {{-- <div class="dropdown-divider"></div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('rtoadmin.rtoadmin')}}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="rtoapplication">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('rtoadmin.rto_application', $type='rto-transfer-application') }}">RTO transfer</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('rtoadmin.rto_application', $type='loan-cancellation-application') }}">Loan cancellation</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('rtoadmin.rto_application', $type='noc-application') }}">NOC</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('rtoadmin.rto_application', $type='repassing-application') }}">Repassing</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('rtoadmin.rto_application', $type='duplicate-registration-certificate-application') }}">Duplicate Registration Certificate</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('rtoadmin.rto_application', $type='license-application') }}">License</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('rtoadmin.rto_application', $type='passing-application') }}">Passing</a></li>
                </ul>
              </div>
            </li>
