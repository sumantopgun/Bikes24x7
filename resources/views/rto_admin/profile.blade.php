            ...
            <div class="wrapper">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                  <form method="POST" action="{{route('rtoadmin.profile.update', $user->id)}}">
                    @csrf
                    @method("PUT")
                    @if (session('message'))
                ...
                <div class="tab-pane fade" id="avatar" role="tabpanel" aria-labelledby="avatar-tab">
                  ...
                  <form method="POST" action="{{route('rtoadmin.updatepic',$user->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                ...
                <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                  <form id="form-change-password" role="form" method="POST" action="{{route('rtoadmin.changepassword')}}">
                    @csrf
                    @method("PUT")
                    <div class="form-group">
