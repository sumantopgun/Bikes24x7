  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('seller.seller')}}"><img src="{{ asset('logo/logo.png')}}" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('seller.seller')}}"><img src="{{ asset('logo/mini_logo.png')}}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
              <a class="dropdown-item font-weight-medium" href="{{ route('seller.profileupdate')}}">
                Edit profile
              </a>
              {{-- <div class="dropdown-divider"></div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('seller.seller')}}">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="user-layouts">
                  <ul class="nav flex-column sub-menu">                    
                    <li class="nav-item"> <a class="nav-link" href="{{ route('seller.orders.index') }}">Active List</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('seller.myorder') }}">Sold List</a></li>
                  </ul>
                </div>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="{{ route('seller.inventorylist') }}">
