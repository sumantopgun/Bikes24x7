                    ...
                    <tbody>
                        @foreach ($activeBooking as $activeBook)
                            <tr>                       
                                ...
                                <td>
                                    {{ $activeBook->billingAddress->billing_phone_no ?? 'N/A' }}              
                                </td>
                                ...
                                <td><div class="badge badge-success badge-fw">{{ $activeBook->bike_sells->bike_sell_status ?? 'N/A' }}</div></td> 
                                <td><a button class="btn btn-outline-primary" href="{{route('seller.orders.show', $activeBook->id)}}">Details</a></td>                            
                            </tr>
                        @endforeach   
                    </tbody>
                </table>                    
            ...
            <div class="modal fade" id="payOnlineId" tabindex="-1" role="dialog" aria-labelledby="payOnline-2" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <form method="POST" class="forms-sample" action="{{ route('seller.payonline') }}">
                        @csrf
