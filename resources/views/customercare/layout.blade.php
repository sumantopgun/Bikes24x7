  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('customercare.customercare')}}"><img src="{{ asset('logo/logo.png')}}" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('customercare.customercare')}}"><img src="{{ asset('logo/mini_logo.png')}}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
              <a class="dropdown-item font-weight-medium" href="{{ route('customercare.profileupdate')}}">
                Edit profile
              </a>
              {{-- <div class="dropdown-divider"></div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <div class="nav-link">
                ...
                <div class="profile-name">
                  ...
                  <p class="designation">
                    @can('isRTOCustomerCare')
                      RTO Customer Care
                    @endcan
                    @can('isBikeCustomerCare')
                      Bike Customer Care
                    @endcan
                  </p>
                </div>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('customercare.customercare')}}">
            ...
            @can('isBikeCustomerCare')             
              <li class="nav-item">
                  <a class="nav-link" data-toggle="collapse" href="#user-layouts" aria-expanded="false" aria-controls="user-layouts">
                    ...
                    <span class="menu-title">Bike Booking List</span>
                    {{-- <span class="badge badge-warning">2</span> --}}
                  </a>
                  <div class="collapse" id="user-layouts">
                    <ul class="nav flex-column sub-menu">                    
                      <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.appointment.index') }}">Active List</a></li>
                      <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.expireList') }}">Expire List</a></li>
                    </ul>
                  </div>
              </li>
            @endcan
            ...
            @can('isRTOCustomerCare')
              <li class="nav-item">
                ...
                <div class="collapse" id="rtoapplication">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.rto_application', $type='rto-transfer-application') }}">RTO transfer</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.rto_application', $type='loan-cancellation-application') }}">Loan cancellation</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.rto_application', $type='noc-application') }}">NOC</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.rto_application', $type='repassing-application') }}">Repassing</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.rto_application', $type='duplicate-registration-certificate-application') }}">Duplicate Registration Certificate</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.rto_application', $type='license-application') }}">License</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.rto_application', $type='passing-application') }}">Passing</a></li>
                  </ul>
                </div>
              </li>
            @endcan

            @can('isBikeBuyCustomerCare')             
              <li class="nav-item">
                  <a class="nav-link" data-toggle="collapse" href="#bikeBuy" aria-expanded="false" aria-controls="bikeBuy">
                    <i class="fa fa-user-o menu-icon"></i>
                    <span class="menu-title">Bike Buy</span>
                    {{-- <span class="badge badge-warning">1</span> --}}
                  </a>
                  <div class="collapse" id="bikeBuy">
                    <ul class="nav flex-column sub-menu">                    
                      <li class="nav-item"> <a class="nav-link" href="{{ route('customercare.bike-buy-request.index') }}">Request List</a></li>
                    </ul>
                  </div>
              </li>
            @endcan
