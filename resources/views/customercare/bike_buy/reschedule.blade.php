...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" class="forms-sample" action="{{ route('customercare.buy_confirm_submit') }}">
                @csrf
                <input class="form-control" type="hidden" name="buy_bike_request_id" value="{{ $request_id }}">
