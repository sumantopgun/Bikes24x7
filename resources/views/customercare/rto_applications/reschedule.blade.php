...
@section('title', 'Application Reschedule')
@push('style')
...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title" style="text-align: center;">Application Reschedule</h4>
            <h6 class="pb-3">
                @error('date')
            ...
            <form method="POST" class="forms-sample" action="{{ route('customercare.rto_reschedule_complete') }}">
                @csrf
                <input class="form-control" type="hidden" name="application_request_id" value="{{ $request_id }}">
                <input class="form-control" type="hidden" name="application_type" value="{{ $type }}">
