            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="appointments_status" disabled value="{{ $application->appointments->appointment_status=='confirmed' ? 'Confirmed' : 'Not confirmed'}} ">
                    </div>
                    <div class="form-group">
                    ...
                    <center>
                        <div class="form-group btn-group" role="group" aria-label="Basic example">   
                            @if ($application->appointments->appointment_status == 'unconfirmed')
                                <a button class="btn btn-primary" href="{{route('customercare.confirm_apllication', ['application_id' => Crypt::encrypt($application->id),'type' => $type ])}}">Confirm</a>
                            @endif                     
                            
                            <a button class="btn btn-danger" href="{{route('customercare.reschedule_apllication', ['application_id' => Crypt::encrypt($application->id),'type' => $type ])}}">Reschedule</a>
                        </div> 
                    </center>
