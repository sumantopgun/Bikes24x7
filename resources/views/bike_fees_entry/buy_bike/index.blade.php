...
<div class="content-wrapper">
    <div class="card">
        ...
        <form class="form-inline" method="POST" action="{{route('bike_fees_entry.importcsv')}}" enctype="multipart/form-data">
            @csrf
        ...
        <a href="{{route('bike_fees_entry.bike-fees-entry.create')}}" type="button" class="btn btn-primary btn-fw" style="float:right;">Add New Fees</a><br><br>
        @if (session('message'))
                        ...
                        <tr id="{{$bike->id}}">                 
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a button class="btn btn-success" href="{{route('bike_fees_entry.bike-fees-entry.edit', $bike->id)}}">Edit</a>
